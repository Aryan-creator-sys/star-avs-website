...
export default function Values() {
  return (
    <section id="approach" className="relative overflow-hidden bg-[#f6f6f4] py-[8vh]">
      ...
      <div className="grid items-center gap-10 md:grid-cols-[0.85fr_1.15fr] md:gap-12">
        ...
        <Reveal delay={0.1} className="order-1 md:order-2">
          <figure>
            <img src="/images/installation-12.png" alt="Home cinema installation with a large projected screen" loading="lazy"
      ...
      <div className="mt-[1vh] grid items-stretch gap-6 md:grid-cols-[1.05fr_0.95fr] md:gap-12">
        <Reveal className="order-1">
          <figure>
            <img src="/images/installation-11.png" alt="Dedicated home theatre with tower speakers and a large screen" loading="lazy"
